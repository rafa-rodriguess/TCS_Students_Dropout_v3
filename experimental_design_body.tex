...
To avoid over-claiming from a narrow operator realization, the framework now exports a mechanism-validity gate and channel-fragility pack (\nolinkurl{table_policy_mech_validity_gate.csv}, \nolinkurl{table_policy_mech_channel_attribution.csv}, \nolinkurl{table_policy_mech_fragility_by_scenario.csv}) as required diagnostics alongside the RQ2 grid.
