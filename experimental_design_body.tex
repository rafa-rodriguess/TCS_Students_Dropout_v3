...
By-group row-level metrics (AUC, Brier, and ECE with 15 bins) and calibration curves are reported on test rows.
...
The main text includes evidence essential to the central argument, namely calibration, $\Delta S$, $\Delta Gap$, and benchmark convergence. Extended diagnostics, including per-group calibration curves, covariate delta profiles, and bootstrap histograms, are placed in the appendix.
