...
The benchmark track provides model-family reference comparisons without replacing the primary hazard pipeline. In the current main-text reporting, the benchmark centers on the temporal hazard model, its IPCW-weighted variant, and a non-temporal Random Survival Forest baseline at aligned horizons. Additional model families, including Cox time-varying specifications \cite{Cox1972RegressionModels}, can serve as auxiliary references.
